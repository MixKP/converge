    ...
    "paths": {
        ...
        "/branches": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "New branch payload",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/branch.CreateBranchRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/branch.UpdateCapacityRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/teachers": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Filter by subject ID (active teachers only)",
                        "name": "subject_id",
                        "in": "query"
                    },
                    {
